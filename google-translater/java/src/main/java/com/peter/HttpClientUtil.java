...
public class HttpClientUtil {
    ...
    public static List<String> userAgentList = CrawlConfig.getUserAgent();
    public static int randomIndex = RandomUtils.nextInt(0, userAgentList.size());
    public static String doGet(String url, Map<String, String> param) {
        ...
        try {
            ...
            httpGet.setHeader("user-agent", userAgentList.get(randomIndex));
